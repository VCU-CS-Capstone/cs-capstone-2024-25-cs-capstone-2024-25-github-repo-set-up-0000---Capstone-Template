...
erDiagram
    ...
    question_requirements }o--o| questions : "Questions might have many requirements"
    question_requirements }o--o| question_options : ""
    ...
    question_requirements{
        i32 id
        i32 question_to_check FK
        i32 question_to_add FK "The question to be added if requirement met"
        i32 has_option FK "Nullable"
        i32 equals_radio FK "Nullable"
        i32 equals_text "Nullable"
        i32 equals_number  "Nullable"
        boolean equals_boolean "Nullable"
    }
    question_options{
        i32 id PK
        i32 question_id FK
