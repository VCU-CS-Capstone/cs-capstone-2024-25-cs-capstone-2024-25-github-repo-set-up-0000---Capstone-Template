...
#| echo: true
sql = f"""
SELECT participants.id, participants.first_name, participants.last_name, case_note_health_measures.blood_pressure_sit_systolic, case_note_health_measures.blood_pressure_sit_diastolic FROM case_note_health_measures
    ...
    WHERE case_note_health_measures.blood_pressure_sit_systolic >= 130 AND case_note_health_measures.blood_pressure_sit_diastolic >= 80;
